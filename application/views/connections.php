...
$datas = json_decode(json_encode($datas), true); foreach ($datas as $choice) { ?>
            <div class="dark-container first">
                ...
                <ul class="connect-opt">
                    ...
                    <li class="pchat">
                        <a href="mailto:<?php echo (base64_decode($choice['CID'])); ?>?subject=Campuspace rocks">
            ...
            <div class="dark-container first">
                ...
                <ul class="connect-opt">
                    <li class="pvideo">
                        <a href="#">
                            <img src="svg-sources/videocam_white_24dp.svg" alt="ico" />
                        </a>
                    </li>

                    <li class="pchat">
                        <a href="#">
                            <img src="svg-sources/email_white_24dp.svg" alt="ico" />
                        </a>
                    </li>

                    <li class="pblock">
                        <a href="#">
                            <img src="svg-sources/block_white_24dp.svg" alt="ico" />
                        </a>
                    </li>
                </ul>
            </div>
