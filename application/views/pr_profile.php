...
<title><?php echo $like_result[0]['SIID']; ?></title>
    ...
    <link rel="stylesheet" href="<?php echo base_url("css/pr_p/style-modals.css");?>">
...
<body>
    ...
    <div class="bg-glass container-lg">
        ...
        <div class="card-body little-profile text-center">
            ...
            <button onclick="location.href='http://localhost/anonimly/index.php/Regcontroller';" id="follow" class="follow-btn">
